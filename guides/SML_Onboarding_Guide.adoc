...
<<../rest/SML_REST_API_Reference_Guide.adoc#, SML Rest API Reference Guide>> for details.

The <<../rest/SML_REST_API_Reference_Guide.adoc#, SML Rest API Reference Guide>> describes the SymetryML REST API. The API lets you create, update, and delete

...
2. Using a local Spark cluster to perform a distributed learn on an S3 datasource. +
...
https://github.com/symetryml/symetryMLv5/tree/master/examples/Python/pyspark[Scala examples] +
1. Using a Spark context to host a symetry project and learn a local data file. +
2. Using a local spark cluster to perform a distributed learn on an S3 data source in a notebook. +
